# Generated by Powerlevel10k configuration wizard on 2025-04-23 at 17:00 EEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #NOTE: moved to left context                 # user@hostname
  ...
  # NOTE: removing this allows for user@host context
